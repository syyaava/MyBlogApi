...
//            Assert.Equal(StatusCode.Success, messageFromDb.Status);
...
//            Assert.NotNull(messageFromDb.Result);
//            Assert.Null(messageFromDb.Exception);
//            Assert.Equal(StatusCode.NotFound, messageFromDb.Status);
//        }
...
//            Assert.Equal(StatusCode.Error, messageFromDb.Status);
...
//            Assert.Equal(StatusCode.Success, messagesFromDb.Status);
...
//            Assert.NotNull(messagesFromDb);
//            Assert.Null(messagesFromDb.Exception);
//            Assert.Equal(StatusCode.NotFound, messagesFromDb.Status);
//            Assert.NotNull(messagesFromDb.Result);
...
//            Assert.Equal(StatusCode.Error, messagesFromDb.Status);
...
//            Assert.Equal(StatusCode.Success, resultOfAdding.Status);
...
//            Assert.Equal(StatusCode.Error, resultOfAdding.Status);
...
//            Assert.Equal(StatusCode.Success, removeResult.Status);
//            Assert.Null(removeResult.Exception);
//            Assert.Equal(StatusCode.NotFound, dbProvider.GetMessage(message.Id.ToString()).Status);
//        }
...
//            Assert.NotNull(removeResult);
//            Assert.NotNull(removeResult.Result);
//            Assert.Equal(StatusCode.NotFound, removeResult.Status);
//            Assert.Null(removeResult.Exception);
//        }
...
//            Assert.NotNull(removeResult);
//            Assert.NotNull(removeResult.Result);
//            Assert.Equal(StatusCode.Error, removeResult.Status);
...
//            Assert.Equal(StatusCode.Success, updateResult.Status);
...
//            Assert.NotNull(updateResult);
//            Assert.NotNull(updateResult.Result);
//            Assert.Equal(StatusCode.NotFound, updateResult.Status);
//            Assert.Null(updateResult.Exception);
//        }
...
//            Assert.NotNull(updateResult);
//            Assert.NotNull(updateResult.Result);
//            Assert.Equal(StatusCode.Error, updateResult.Status);
